...
function simulateTelemetry() {
    ...
    if (score < 40) {
        ...
        aiStatusPanel.innerHTML = '<i class="fa-solid fa-triangle-exclamation"></i> AI ALERT: CONTAMINATION DETECTED <span id="safety-score"></span>';
        ...
        aiStatusPanel.innerHTML = '<i class="fa-solid fa-shield-halved"></i> AI Safety Index: <span id="safety-score"></span>';
        document.getElementById('safety-score').innerText = `${score}%`;
